...
* __Aller plus loin__ : Remplacer l'histogramme par un graphique dynamique en utilisant le package **rAmCharts** (http://datastorm-open.github.io/introduction_ramcharts/). (``amHist``)
...
* __Aller plus loin__ : changer le *thème* de l'application en insérant un ``.css`` externe (``tags$head`` & ``tags$link``). Par exemple en utilisant [bootswatch](http://bootswatch.com/)http://bootswatch.com/)...
